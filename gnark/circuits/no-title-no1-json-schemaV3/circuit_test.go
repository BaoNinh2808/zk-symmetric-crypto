...
func TestCipher(t *testing.T) {
	...
	block0.Ref_index = uints.U8{Val: 0xff}
	block1.Ref_index = uints.U8{Val: 1}
	block2.Ref_index = uints.U8{Val: 0}
	block3.Ref_index = uints.U8{Val: 3}

	block0.Len = uints.U8{Val: 1}
	...
	// criteria_block_val.Data[0] = uints.NewU32(61)
	...
	// ref_obj_key := NewObjectKeyBlock()
	// ref_obj_key.Data[0] = uints.NewU32(age_key)

	// crit0 := Criteria{
	// 	InArrayPart:  false,
	// 	Ref_obj_key:  *ref_obj_key,
	// 	Criteria_key: *criteria_block_key,
	// 	Criteria_val: *criteria_block_val,
	// }
	...
	// block00.Len = uints.U8{Val: 1}
	// block00.Data[0] = uints.NewU32(age_key)
	crit0.RefsCheckObj = []Block{*block0}

	// crit1 := NewCriteria()
	// crit1.Refs = []int{REF_TO_KEY}
	// crit1.RefObj = *block0
	// crit1.CritKey = *block2
	// crit1.CritVal = *block3
	// crit1.CritVal.Data[0] = uints.NewU32(61)
